...
* A running DENTNet node (see [operating-a-node.md](../operating-a-node.md "mention"))
...
{% embed url="https://survey.typeform.com/to/pC369PTd" %}

### Payout and Rewards

Please carefully read the [validators.md](../../overview/core-concepts/proof-of-stake/validators.md "mention") section for the payout and rewards system of DENTNet Validators.&#x20;
